...
<body>
    ...
    <div style="padding-top: 45px;">
        <div id="mySidenav" class="sidenav">
            ...
            <a class="btns active" href="userhome.php">ສ້າງເອກະສານ</a>
            <a class="btns" href="usersearchfile.php">ຄົ້ນຫາເອກະສານ</a>
        </div>
        ...
        <div id="main" class="contents">
            <div class="container">
                ...
                <h>
                    ...
                    <form action="usersavefile.php" method="POST" class="needs-validation" novalidate>
                            ...
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input name="admin" type="text" class="form-control form-control-sm" placeholder="" required>
